...
export default async function StaticTags() {
  ...
  return (
    <div className="max-w-5xl flex flex-row flex-wrap gap-4">
      {staticTags.map((tagInfo: { name: string; count: number }) => (
        <div className="py-2 px-4 bg-gradient-to-r from-gray-500 to-gray-800 rounded-2xl flex flex-wrap gap-2">
